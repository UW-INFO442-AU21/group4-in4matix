    ...
    if (hasTakenQuiz()) {
      return(
        <div>
          ...
          <Button aria-label="Retake quiz" variant="warning" onClick={resetResults}>Retake quiz</Button>
          <Link aria-label="View results of quiz" className="btn btn-success" role="button" to="/group4-in4matix/results">
                View Results
          </Link>
