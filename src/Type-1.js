    ...
    <div className="content">
      ...
      <h2>Overview</h2>
        ...
        <div className="float-video">
          <iframe className="responsive-iframe" aria-label="Perfectionist overview" src="https://www.youtube.com/embed/MFd7I4iWeTg?start=80" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
        </div>
      <h2>General Tips</h2>
        <ul>
          <li>
